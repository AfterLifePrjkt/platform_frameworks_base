 ...
 */
open class LandscapeBatteryA(private val context: Context, frameColor: Int) : Drawable() {
    ...
    private fun loadPaths() {
        ...
        val fillMaskString = context.resources.getString(
                R.string.config_landscapeBatteryFillMaskA)
        fillMask.set(PathParser.createPathFromPathData(fillMaskString))
        // Set the fill rect so we can calculate the fill properly
        fillMask.computeBounds(fillRect, true)

        val boltPathString = context.resources.getString(
                R.string.config_landscapeBatteryBoltPathA)
    ...
    companion object {
        private const val TAG = "LandscapeBatteryA"
