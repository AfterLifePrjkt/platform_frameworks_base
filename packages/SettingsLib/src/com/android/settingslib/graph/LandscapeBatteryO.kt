 ...
 */
open class LandscapeBatteryO(private val context: Context, frameColor: Int) : Drawable() {
    ...
    companion object {
        private const val TAG = "LandscapeBatteryO"
