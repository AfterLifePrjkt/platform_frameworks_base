 ...
 */
open class LandscapeBatteryM(private val context: Context, frameColor: Int) : Drawable() {
    ...
    override fun draw(c: Canvas) {
        ...
        levelRect.bottom = Math.floor(fillBottom.toDouble()).toFloat()
    ...
    private fun loadPaths() {
        ...
        val boltPathString = context.resources.getString(
                R.string.config_landscapeBatteryBoltPathM)
        boltPath.set(PathParser.createPathFromPathData(boltPathString))

        val plusPathString = context.resources.getString(
                R.string.config_landscapeBatteryPowersavePathM)
    ...
    companion object {
        private const val TAG = "LandscapeBatteryM"
