 ...
 */
open class LandscapeBatteryI(private val context: Context, frameColor: Int) : Drawable() {
    ...
    private var customFillRainbow = false
    ...
    override fun draw(c: Canvas) {
        ...
        if (customBlendColor && powerSaveColor != BLACK) powerSaveColor else Utils.getColorStateListDefaultColor(context, R.color.batterymeter_plus_color)
        ...
        if (dualTone) {
            ...
            if (customFillRainbow) {
                if (charging) {
                    ...
                    if (batteryLevel >= 91 && batteryLevel <= 100) {
                    ...
                    if (batteryLevel >= 81 && batteryLevel <= 90) {
                        c.drawPath(scaledFill9, customFillPaint9)
                        c.drawPath(scaledFill8, customFillPaint8)
                        c.drawPath(scaledFill7, customFillPaint7)
                        c.drawPath(scaledFill6, customFillPaint6)
                    ...
                    if (batteryLevel >= 71 && batteryLevel <= 80) {
                        c.drawPath(scaledFill8, customFillPaint8)
                        c.drawPath(scaledFill7, customFillPaint7)
                        c.drawPath(scaledFill6, customFillPaint6)
                        c.drawPath(scaledFill5, customFillPaint5)
                    ...
                    if (batteryLevel >= 61 && batteryLevel <= 70) {
                        c.drawPath(scaledFill7, customFillPaint7)
                        c.drawPath(scaledFill6, customFillPaint6)
                        c.drawPath(scaledFill5, customFillPaint5)
                        c.drawPath(scaledFill4, customFillPaint4)
                    ...
                    if (batteryLevel >= 51 && batteryLevel <= 60) {
                        c.drawPath(scaledFill6, customFillPaint6)
                        c.drawPath(scaledFill5, customFillPaint5)
                        c.drawPath(scaledFill4, customFillPaint4)
                        c.drawPath(scaledFill3, customFillPaint3)
                    ...
                    if (batteryLevel >= 41 && batteryLevel <= 50) {
                        c.drawPath(scaledFill5, customFillPaint5)
                        c.drawPath(scaledFill4, customFillPaint4)
                        c.drawPath(scaledFill3, customFillPaint3)
                        c.drawPath(scaledFill2, customFillPaint2)
                    ...
                    if (batteryLevel >= 31 && batteryLevel <= 40) {
                        c.drawPath(scaledFill4, customFillPaint4)
                        c.drawPath(scaledFill3, customFillPaint3)
                        c.drawPath(scaledFill2, customFillPaint2)
                        c.drawPath(scaledFill1, customFillPaint1)
                    }
                    if (batteryLevel >= 21 && batteryLevel <= 30) {
                        c.drawPath(scaledFill3, customFillPaint3)
                        c.drawPath(scaledFill2, customFillPaint2)
                        c.drawPath(scaledFill1, customFillPaint1)
                    }
                ...
                if (charging) {
                    ...
                    c.drawPath(levelPath, if (customBlendColor && chargingColor != BLACK) chargingPaint else defaultFillPaint)
                    c.drawPath(scaledBolt, fillPaint)
                    c.clipPath(scaledFill)
                } else if (powerSaveEnabled) {
                    c.drawPath(scaledErrorPerimeter, powerSavePaint)
                    ...
                    c.drawPath(levelPath, if (customBlendColor && powerSaveFillColor != BLACK) powerSaveFillPaint else defaultFillPaint)
                    c.clipPath(scaledFill)
                } else {
                    c.drawPath(scaledPerimeter, scaledPerimeterPaint)
                    c.clipOutPath(scaledfillOutline)
                    ...
                    c.drawPath(levelPath, if (customBlendColor && customFillColor != BLACK) customFillPaint else defaultFillPaint)
                    c.clipPath(scaledFill)
                }
            }
            if (!charging && !showPercent) {
                if (batteryLevel >= 71 && batteryLevel <= 100) {
                    c.drawPath(scaledNgguyu, fillPaint)
                }
                if (batteryLevel >= 41 && batteryLevel <= 70) {
            ...
            if (batteryLevel <= Companion.CRITICAL_LEVEL && !charging && !customFillRainbow) {
                c.save()
                c.clipPath(scaledFill)
    ...
    private fun loadPaths() {
        ...
        val boltPathString = context.resources.getString(
                R.string.config_landscapeBatteryBoltPathI)
        boltPath.set(PathParser.createPathFromPathData(boltPathString))

        val plusPathString = context.resources.getString(
                R.string.config_landscapeBatteryPowersavePathI)
