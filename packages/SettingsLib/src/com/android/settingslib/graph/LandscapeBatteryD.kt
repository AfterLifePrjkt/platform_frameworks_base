 ...
 */
open class LandscapeBatteryD(private val context: Context, frameColor: Int) : Drawable() {
    ...
    private fun loadPaths() {
        ...
        val boltPathString = context.resources.getString(
                R.string.config_landscapeBatteryBoltPathD)
        boltPath.set(PathParser.createPathFromPathData(boltPathString))

        val plusPathString = context.resources.getString(
                R.string.config_landscapeBatteryPowersavePathD)
    ...
    companion object {
        private const val TAG = "LandscapeBatteryD"
