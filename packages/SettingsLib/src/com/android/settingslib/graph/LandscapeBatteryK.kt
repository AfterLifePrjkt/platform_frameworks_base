 ...
 */
open class LandscapeBatteryK(private val context: Context, frameColor: Int) : Drawable() {
    ...
    companion object {
        private const val TAG = "LandscapeBatteryK"
