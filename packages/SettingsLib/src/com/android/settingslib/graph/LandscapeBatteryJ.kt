 ...
 */
open class LandscapeBatteryJ(private val context: Context, frameColor: Int) : Drawable() {
    ...
    private fun loadPaths() {
        ...
        val boltPathString = context.resources.getString(
                R.string.config_landscapeBatteryBoltPathJ)
        boltPath.set(PathParser.createPathFromPathData(boltPathString))

        val plusPathString = context.resources.getString(
                R.string.config_landscapeBatteryPowersavePathJ)
    ...
    companion object {
        private const val TAG = "LandscapeBatteryJ"
